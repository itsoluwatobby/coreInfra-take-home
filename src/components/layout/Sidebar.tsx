...
export default function Sidebar() {
  return (
    <aside className="hideScrollbar sticky top-0 sm:w-[14.375rem] flex-none max-xxs:w-16 p-2 py-8 max-xxs:h-full h-screen border-r border-r-[#DEDEDF] flex flex-col gap-32 overflow-y-scroll">
